...
export default function Herosection() {
  return (
    <>
        <div classNameName="b-example-divider" />
...
<div className="container col-xxl-8 px-4 py-5">
  <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
    ...
    <div className="col-lg-6">
      <h1 className="display-5 fw-bold lh-1 mb-3 text-secondary">Responsive left-aligned hero with image</h1>
      ...
      <div className="d-grid gap-2 d-md-flex justify-content-md-start">
        <button type="button" className="btn btn-primary btn-lg px-4 me-md-2 text-secondary">Primary</button>
        <button type="button" className="btn btn-outline-secondary btn-lg px-4 text-secondary">Default</button>
      </div>
    </div>
  </div>
</div>
